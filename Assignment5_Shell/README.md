...
- Name: Aida Sharif Rohani
- How many hours did it take you to complete this assignment? more than 25 hours!
- Did you collaborate with any other students/TAs/Professors? No
- Did you use any external resources? (Cite them below)
  - http://www.cs.loyola.edu/~jglenn/702/S2005/Examples/dup2.html
  - https://beej.us/guide/bgipc/html/multi/pipes.html
 - https://www.geeksforgeeks.org/isalpha-isdigit-functions-c-example/
- https://www.csd.uoc.gr/~hy345/assignments/2016/assign1/Tutorial1.pdf
-https://www.mkssoftware.com/docs/man3/dup2.3.asp
-https://en.cppreference.com/w/cpp/string/basic_string/getline
- (Optional) What was your favorite part of the assignment? This was such a huge program and in such a short time we had I can't tell if I liked any part or not.
...
Game is a guess game for numbers between 1 to 10!

DESCRIPTION:

The program reads the user input and verifies if it is an integer. If yes it starts checking against the random number
it generated. If more than 20 numbers are guessed the program finishes and you get back to mini-shell.
Program gives hints as of the number is too high or too low.

NOTES:

I used strand to generate random number, used sscanf to read input from user, checked the number and wrote back the results.
